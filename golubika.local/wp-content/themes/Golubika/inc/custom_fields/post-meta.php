...
2 sections inside, magnet clasp</i>' )
  ...
  Container::make( 'post_meta', 'Добавление товара в категорию АКСЕСУАРЫ (большие фото). Украинская версия.' )
    ...
    Container::make( 'post_meta', 'Add your good to ACCESSORIES category (big photos). English version.' )
        ->where( 'post_term', '=', array(
                   'field' => 'id',
                   'value' => 91,
                   'taxonomy' => 'category',
  ...
  Container::make( 'post_meta', 'Добавление товара в категорию АКСЕСУАРЫ (маленькие фото). Украинская версия.' )
    ...
    Container::make( 'post_meta', 'Add your good to ACCESSORIES category (small photos). English version.' )
        ->where( 'post_term', '=', array(
                   'field' => 'id',
                   'value' => 95,
                   'taxonomy' => 'category',
