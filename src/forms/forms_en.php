	...
	<form method="post"
		...
		<div class="modal-dialog" role="document">
	      ...
	      <div class="modal-footer">
	        ...
	        <button type="submit" class="send_form btn" id="callback_btn">Contact me</button>
		    </div>
			</div>
		</div>
	</form>
  	...
  	<div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-body feedback_body">
	        <p>Thank you! <br> We will contact you soon.</p>
	        <p>Best regards, Golubika.</p>
	      </div>
	      <div class="modal-footer">
	...
	<div class="modal fade show" id="order_feedback">
  	<div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-body feedback_body">
	        <p>Thank you for your order! <br> We will contact you soon to discuss all the details.</p>
	        <p>Best regards, Golubika.</p>
	      </div>
	      <div class="modal-footer">
	        <button type="button" class="btn btn-sm feedback" data-dismiss="modal">OK</button>
	...
	<div class="modal fade show" id="customOrder_feedback">
  	<div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-body feedback_body">
	        <p>Thank you! <br> We will contact you soon to discuss all the details of your individual order.</p>
	        <p>Best regards, Golubika.</p>
	      </div>
	      <div class="modal-footer">
	        <button type="button" class="btn btn-sm feedback" data-dismiss="modal">OK</button>
